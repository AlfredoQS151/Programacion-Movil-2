...
fun GameScreen() {
    ...
    Box(
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            // Dibuja la portería superior (roja)
            drawRect(Color.Red, Offset(goalLeft, 2262 - frameThickness), Size(goalWidth, frameThickness))

            // Dibuja la portería inferior (azul)
            drawRect(Color.Blue, Offset(goalLeft, 50 - goalHeight), Size(goalWidth, frameThickness))
        }
